...
// export const APPOINTMENTS_ITEMS = [
//   {
//     national: 856341,
//     patient: "Amina AI-s",
//     doctor: "Dr.Ahmed",
...
export const DOCTORS_ITEMS = [
  {
    name: "Ali Rezaie",
    phone: "+966 50 123 4567",
    spec: "Cardioiogy",
    joinDate: format(new Date(2025, 1, 7), "EEE,d MMM yyyy"),
    status: "Active",
    action: "View",
  },
  {
    ...
    spec: "Cardioiogy",
    joinDate: format(new Date(2025, 3, 12), "EEE,d MMM yyyy"),
    status: "Inactive",
    action: "View",
  },
  {
    ...
    spec: "Cardioiogy",
    joinDate: format(new Date(2026, 2, 5), "EEE,d MMM yyyy"),
    status: "Active",
    action: "View",
  },
  {
    ...
    spec: "Cardioiogy",
    joinDate: format(new Date(2024, 1, 1), "EEE,d MMM yyyy"),
    status: "Inactive",
    action: "View",
  },
];
